...
<body>
    ...
    <div class="container">
        ...
        <p class="subtitle">Nhập thông tin chi tiết của sản phẩm để lưu kho</p>
        ...
        <form action="<?php echo BASE_URL; ?>/admin/productStore" method="POST" enctype="multipart/form-data">
            <!-- Tên sản phẩm -->
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                .then(async res => {
                    ...
                    if (!res.ok) {
                        let errorMsg = data.message || "Lỗi khi thêm sản phẩm.";
                        if (data.errors) {
